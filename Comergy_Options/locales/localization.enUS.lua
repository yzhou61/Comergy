if (true) then
    ...
    COMERGY_WIDTH = "Length"
    COMERGY_SPACING = "Spacing"
    COMERGY_FONT_SIZE = "Font size"
    COMERGY_DURATION_SCALE = "Fading delay"
    COMERGY_LOW = "Low"
    COMERGY_HIGH = "High"
    COMERGY_ENERGY_HEIGHT = "Energy bar thickness"
    COMERGY_COMBO_BG_ALPHA = "Combo BG alpha"
    COMERGY_COMBO_HEIGHT = "Combo bar thickness"
    COMERGY_COMBO_FANCY = "Fancy combo bars"
    COMERGY_LEFT = "Left"
    COMERGY_RIGHT = "Right"
    ...
    COMERGY_HCENTER = "Horizontal center"
    COMERGY_VCENTER = "Vertical center"

    COMERGY_CHECKOPTINFO = {
        ["ShowOnlyInCombat"] = "Hide Comergy out of combat",
        ["ShowInStealth"] = "but show in Stealth and Shadow Dance",
        ...
        ["UnifiedComboColor"] = "Unified combo color",
        ["ComboFlash"] = "Flash combo points when 5 Combos",
        ["ShowTargetHealthBar"] = "Show target's health bar",
    }
